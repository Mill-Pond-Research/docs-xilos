...
- **[Compliance Frameworks](/governance/compliance)** — Xilos supports HIPAA, GDPR, and SOC 2 compliance with built-in controls.
- **[Data Residency](/governance/data-residency)** — Control where your data is stored — US, EU, APAC, or on-premise.
- **[Audit Trail](/governance/audit-trail)** — Every query, routing decision, and configuration change is logged and searchable.
- **[Role-Based Access](/governance/role-based-access)** — Three roles — SuperAdmin, Org Admin, and User — with scoped permissions.
- **[SIEM Integration](/api-reference/siem)** — Forward governance events to your SIEM platform in CEF, Syslog, or JSON format.
- **[Restriction Rules](/api-reference/restriction-rules)** — Block, mask, or flag queries that violate your security policies.
