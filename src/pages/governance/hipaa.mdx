...
<Callout type="warning">
  Xilos is a Business Associate under HIPAA when processing PHI. A BAA must be executed between your organization (the Covered Entity) and Xilos before processing any PHI. Contact Xilos to execute a BAA.
</Callout>
...
<Callout type="info">
  Limit the number of SuperAdmin and Org Admin roles. Most users should have the User role with a [virtual key](/api-reference/virtual-keys) scoped to their needs.
</Callout>

## Related

<Cards>
  <Card title="Data Residency" href="/governance/data-residency">Configure US-only data storage.</Card>
  <Card title="Audit Trail" href="/governance/audit-trail">Search and export audit logs.</Card>
  <Card title="Restriction Rules API" href="/api-reference/restriction-rules">Block or mask PHI in queries.</Card>
  <Card title="SIEM Export API" href="/api-reference/siem">Forward events to your SIEM.</Card>
</Cards>
