...
> **Info:** On-Premise deployments provide the strongest data residency guarantee: complete data sovereignty with no external dependencies. See the [Three-Phase Journey](/deployment/three-phase-journey) for guidance on when to move to On-Premise.
