...
<Callout type="warning">
  Fine-tuning on noisy or low-quality data can degrade model performance. Always apply quality filters and review a sample of your training data before creating a fine-tune job.
</Callout>
...
<Callout type="info">
  If you plan to deploy to [On-Premise](/deployment/on-premise), choose an open-weight base model like Llama or Mistral so you can self-host the fine-tuned result.
</Callout>
...
<Card title="Fine-Tune API" href="/api-reference/fine-tune">
  API reference for listing base models, creating jobs, and tracking status.
</Card>

<Card title="Training Data API" href="/api-reference/training-data">
  API reference for exporting and previewing training data.
</Card>

<Card title="Eval Datasets API" href="/api-reference/eval-datasets">
