...
- **[Data must stay in your cloud](/deployment)** — Your data residency or compliance requirements mandate data stays in your account.
- **[Network-level control](/deployment)** — You need custom network policies, VPC peering, or private connectivity.
- **[Compliance with BAA](/governance/hipaa)** — You need HIPAA compliance with a Business Associate Agreement.
- **[GDPR EU data residency](/governance/gdpr)** — You need EU data residency for GDPR compliance.
