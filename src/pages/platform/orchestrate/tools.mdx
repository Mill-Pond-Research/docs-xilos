...
- **[Tool Marketplace](#tool-marketplace)** — Browse and install pre-built tools for common integrations.
- **[Custom Tools](#creating-custom-tools)** — Build your own tools with a simple schema and endpoint.
- **[MCP Servers](#mcp-server-integration)** — Connect any MCP-compatible server for instant tool discovery.
- **[Auto-Tool Selection](#auto-tool-selection)** — Let Xilos pick the right tool based on query intent.
