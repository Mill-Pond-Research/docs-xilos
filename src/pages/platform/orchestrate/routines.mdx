...
> **Info:** Combine the `webhook` output with [Webhooks](/platform/orchestrate/webhooks) to pipe routine results into Slack, Microsoft Teams, or any HTTP-compatible system.
