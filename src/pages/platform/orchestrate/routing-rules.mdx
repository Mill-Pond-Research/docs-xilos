...
<Callout type="warning">
  Keyword-based routing may miss queries phrased differently. A rule triggered by the keyword "invoice" only matches queries containing that exact word.
</Callout>
...
<Tabs>
  <Tabs.Tab title="Claude (Anthropic)">
    - Claude Opus 4
    - Claude Sonnet 4
    - Claude Sonnet 3.7
    - Claude Haiku 3.5
  </Tabs.Tab>
  <Tabs.Tab title="GPT (OpenAI)">
    - GPT-4.1
    - GPT-4.1-mini
    - GPT-4.1-nano
    - GPT-4o
  ...
  <Tabs.Tab title="Gemini (Google)">
    - Gemini 2.0 Flash
    - Gemini 2.0 Flash-Lite
  </Tabs.Tab>
  <Tabs.Tab title="Private Models">
...
<Callout type="warning">
  Routing rules cannot be edited after saving. However, you can enable/disable rules, create new rules with updated criteria, or delete rules. Thoroughly test before saving.
</Callout>
