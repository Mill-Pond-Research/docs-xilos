...
<Callout type="info">
  **Natural Language (Recommended)** — Uses the internal SLM to understand query intent. Recognizes queries even when phrased differently. Best for intent-based routing.
...
<Callout type="warning">
  Routing rules cannot be edited after saving. You can enable/disable, create new rules, or delete. Test thoroughly before saving.
</Callout>
