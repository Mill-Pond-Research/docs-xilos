...
<Callout type="info">
  Xilos supports multi-modal content. Set the message `content` to an array of parts (text + image_url) to send images. Only models with `supports_images: true` will accept image content.
</Callout>
