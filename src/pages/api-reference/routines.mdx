...
<Callout type="info">
  Cron expressions use standard 5-field format: `minute hour day-of-month month day-of-week`. Times are in UTC.
</Callout>
...
<Callout type="info">
  Manual runs do not affect the scheduled cadence. The routine will still execute at its next scheduled time.
</Callout>
