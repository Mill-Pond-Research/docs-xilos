...
> **Info:** Setting `min_faithfulness` and `min_relevance` to `0.7` or higher is recommended for fine-tuning. This ensures your training data only includes high-quality responses.
