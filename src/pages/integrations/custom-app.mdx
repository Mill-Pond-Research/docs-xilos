...
<Callout type="info">
  For production deployments, use a [Virtual Key](/guides/virtual-keys) instead of your master API key. Virtual Keys support scoped budget limits, rate limits, and per-key usage tracking — ideal for multi-tenant applications.
</Callout>
